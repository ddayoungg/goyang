		...
		<form action="action_page.php">
			...
			<div style="margin: 50px 0 80px 0">
				<table class="member" style="width:100%">
					<tr>
						<th>이름</th>
						<td><input name="name" size="10" disabled="disabled" value="홍다영"></td>
					</tr>
					<tr>
						<th>아이디</th>
						<td><input  name="id" size="20" disabled="disabled" value="ekdanabab"></td>
					</tr>
					<tr>
						<th>비밀번호</th>
						<td><input type="password" title="pass" size="20" disabled="disabled" value="******"></td>
					</tr>
					<tr>
						<th>휴대폰번호</th>
						<td><input name="phone_number" value="010-1234-5678"  style= width:280px></td>
					</tr>
					<tr>
						<th>이메일</th>
						<td><input  name="email" value="hhh123@naver.com"  style= width:280px></td>
					</tr>
					<tr>
						<th>우편번호</th>
						<td><input name="zip" value="06235"  style= width:280px></td>
					</tr>
					<tr>
						<th>주소</th>
						<td><input name="address" value="서울특별시 강남구 역삼동 한독빌딩"  style= width:280px></td>
					</tr>
					<tr>
						<th>관심있는 코스</th>
			...
			<span style="position: relative; float: right; margin-top: -50px;">
				<input type="submit" value="수정" class="mainBtn" onclick="showPopup(true,'popup')" style="width:100px; height:32px;">
	...
	<div id="popup" class="hide popup">
	  <div class="content">
		<div style="width: 450px;">
			...
			display: flex; align-items: center; background-color: #f0f6f9; border: 1px solid #ddd; margin-bottom: 5px">내 정보 수정완료</div>
			
			<div style="background-color: #f0f6f9;">
				<div style="font-size: 16px; display: flex; justify-content: center; 
				align-items: center; height: 70px ;background-color: #f0f6f9;">수정되었습니다.<br></div>
				
				<div style="display: flex; align-items: center; justify-content: center; padding-bottom: 10px;">
					<input type="button" value="확인" class="popupBtn" onclick="location.href='user_mypage.jsp'">
				</div>
			</div>
		</div>
	  </div>
