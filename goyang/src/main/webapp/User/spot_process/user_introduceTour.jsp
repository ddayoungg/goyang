			...
			<div class="col-6 col-md-6 col-lg-3">
				<div class="media-1">
					...
					<div class="img-align">
						...
						<img src="E:/web_service_goyang/images/<%=thumImg%>" alt="Image" class="img-fluid">
						</a>
					</div>
					<!-- </form> -->
					<div class="d-flex">
				...
				%>
					<div class="img-align">
						<a class="d-block mb-3"  href="user_introduceDay.jsp?tourNum=<%=toVO.getTourNum() %>"><img
							src="E:/web_service_goyang/images/<%=thumImg%>" alt="Image" class="img-fluid"></a>
					</div>
					<div class="d-flex">
						<div>
							<h3 class="p-text-align">
					...
					<div class="h-100">
						<div class="frame h-100">
							<div class="feature-img-bg h-100"
								style="background-image: url('E:/web_service_goyang/images/버스사진.jpg'); background-size: contain;"></div>
						</div>
					</div>
