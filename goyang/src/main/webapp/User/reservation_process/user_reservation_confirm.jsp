...
<body>
	...
	<div class="untree_co-section">
		<ul class="list_sub_menu">
			...
			<li class="_sub"><a href="user_reservation_confirm.jsp"> <span
					class="menu_text">투어 예약 확인</span>
			</a></li>
			</ul>
			</div>
			<!-- 상단 투어 메뉴 끝 -->
	...
	<div class="container">
		<form>
			<!-- <div style="padding-bottom: 15px; border-bottom:1px solid grey; font-size: 23px;margin: 50px 0px 10px 0px;display: flex;justify-content: space-between;">
				<div style="font-weight: bold;"> 화요나들이(벽제)</div>
			</div>
			
			<div style="padding-bottom: 15px; font-size: 23px;margin: 50px 0px 10px 0px;display: flex;justify-content: space-between;">
				<div style="font-weight: bold;"> 버스 좌석 선택</div>
			</div> -->
			...
			<div style="margin-bottom: 30px;">
				<table class="member" style="width: 100%;">
					...
					<tr>
						<th>날짜</th>
						<td><span>2022년 10월 5일</span><br>10:00 ~ 16:00</td>
					</tr>
					<tr>
						<th>인원 수</th>
						<td>성인(6,000원) : <span>2</span>명<br>기타(4,000원) : <span>2</span>명</td>
					</tr>
					<tr>
						<th>예약한 좌석 번호</th>
						<td>18, 19, 20, 21</td>
			...
			<div style="display: flex; flex-direction: column; align-items: end; font-size: 16px;">
				<div style="width: 40%; padding-bottom: 15px; border-bottom: 1px solid grey;">
					<div style="display: flex; justify-content: space-between;">
						<div>성인 : </div>
						<div>6,000 X <span>2</span> = <span>12,000</span></div>
					</div>
					<div style="display: flex; justify-content: space-between;">
						<div>기타 : </div>
						<div>4,000 X <span>2</span> = <span>8,000</span></div>
					</div>
				</div>
				<div style="display: flex; justify-content: space-between;width: 40%; padding-top: 20px;">
					<div>총 지불 요금</div>
					<div><span>20,000</span>원</div>
				</div>
			</div>
			
			<div style="display: flex; justify-content: end; margin: 20px 0;">
				<input type="button" value="결제하기" class="mainBtn" onclick="showPopup(true,'popup')" style="width: 80px; height: 32px;">
			</div>
